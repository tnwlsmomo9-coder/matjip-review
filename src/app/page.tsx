...
export default function Home() {
  return (
    <>
      <Header />
      <main className="flex flex-1 flex-col gap-12 pb-16 sm:gap-16 lg:gap-20">
        <div className="relative flex flex-col items-center gap-8 overflow-hidden px-4 py-12 sm:gap-10 sm:py-16 lg:py-20">
          <div
            aria-hidden
